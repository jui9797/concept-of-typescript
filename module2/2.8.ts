...
const createPromise =() : Promise<Apple>=>{   //aikhne string er jaygay something type use kora hoise
    return new Promise<Apple>((resolve, reject)=>{   // aikhne string er jaygay something type use kora hoise
